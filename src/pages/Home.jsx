...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const recentArticles = articles.sort((a, b) => new Date(b.date) - new Date(a.date))
    articles[0]
  ...
  //const troisArticles =articles.slice(0,3)
    ...
    <div className="min-h-screen bg-[#0E1217]">
        <div className="container mx-auto px-4 pt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
             ...
             <LatestArticles arrayArt={lastArticles}/> {/*// sau{troisArticles}*/}
             </div>
             <div>
            <Newsletter />
        </div>
