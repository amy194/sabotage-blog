    ...
    return (
      <>
       ...
       {authors.map((author, i) => ( 
              <Card key={i} className="max-w-sm mx-auto my-4 bg-[#1A202C] transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-xl">
                ...
                {/* Il faut appeler l'image de l'article */} 
               
                    <img src={author.authorImageUrl} alt={author.author} className="authorImageUrl" />
                  </div>
                  <Typography variant="h5" className="mb-2 text-center text-[#E11D48]">
                     {author.author} {/*On affiche le nom de l'author  */}
                  </Typography>
                </CardBody>
